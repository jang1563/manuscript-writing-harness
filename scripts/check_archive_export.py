#!/usr/bin/env python3
"""Check archive-export readiness and optionally write outputs."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--strict", action="store_true", help="Exit non-zero unless archive readiness is ready.")
