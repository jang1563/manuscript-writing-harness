...
This section demonstrates the intended display-item-backed writing pattern for the harness.
...
The example table shows how a reproducible manuscript harness should present ranked model-performance summaries: the ordering is deterministic, the JSON output remains machine-readable, and the fact sheet captures the specific claim the table is expected to support.
